    ...
    while (choice != 6) {
        ...
        case 2:
            ...
            if (contact_recieve != NULL) {
                ...
                ERROR_message(search_info);
            }
            break;

        case 3:
            // Updating a contact case
            printf("================================\n");
